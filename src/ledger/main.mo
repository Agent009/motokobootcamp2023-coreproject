...
shared ({ caller = initializer }) actor class Ledger() = this {
  ...
  public func mb_genesis() : async () {
      let log = makeGenesisChain();
      return;
  };
  ...
  func makeGenesisChain() : TxLog {
    ...
    let myAccount : Account = {
      owner = Principal.fromText("jxic7-kzwkr-4kcyk-2yql7-uqsrg-lvrzb-k7avx-e4nbh-nfmli-rddvs-mqe");
      subaccount = ?defaultSubaccount;
    };
    let myAccountB : Account = {
      owner = Principal.fromText("bi3lr-cwsga-wc4qg-ypqug-mkn4l-2l436-yxpkm-dozec-ah3nq-qmjqo-lae");
      subaccount = ?defaultSubaccount;
    };
