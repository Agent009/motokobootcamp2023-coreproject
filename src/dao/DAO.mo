...
Deploy basic_dao with initial accounts.
...
shared actor class DAO(init : ?Types.BasicDaoStableStorage) = Self {
    ...
    stable var system_params : Types.SystemParams = switch (init) { case null { Types.defaulSystemParams }; case (?i) { i.system_params }};
